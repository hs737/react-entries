                                    ...
                                    <ul className="navigation navigation-main navigation-accordion">
                                        ...
                                        <li>
                                            ...
                                            <ul>
                                                ...
                                                <li className="active"><a href="boxed_default.html">Boxed with default sidebar</a></li>
                                                <li><a href="boxed_mini.html">Boxed with mini sidebar</a></li>
                                                <li><a href="boxed_full.html">Boxed full width</a></li>
                                            </ul>
                                        </li>
                                        <li>
                                            <a href="#"><i className="icon-copy"></i> <span>Layouts</span></a>
                                            <ul>
                                        ...
                                        <li>
                                            <a href="#"><i className="icon-droplet2"></i> <span>Color system</span></a>
                                            <ul>
                                        ...
                                        <li><a href="changelog.html"><i className="icon-list-unordered"></i> <span>Changelog <span className="label bg-blue-400">1.4</span></span></a></li>
                                        <li><a href="../../RTL/index.html"><i className="icon-width"></i> <span>RTL version</span></a></li>
                                        {/* <!-- /main --> */}

                                        {/* <!-- Forms --> */}
                                        <li className="navigation-header"><span>Forms</span> <i className="icon-menu" title="Forms"></i></li>
                                        <li>
                                            <a href="#"><i className="icon-pencil3"></i> <span>Form components</span></a>
                                            <ul>
                                        ...
                                        <li>
                                            <a href="#"><i className="icon-file-css"></i> <span>JSON forms</span></a>
                                            <ul>
                                        ...
                                        <li>
                                            <a href="#"><i className="icon-footprint"></i> <span>Wizards</span></a>
                                            <ul>
                                        ...
                                        <li>
                                            <a href="#"><i className="icon-spell-check"></i> <span>Editors</span></a>
                                            <ul>
                                        ...
                                        <li>
                                            <a href="#"><i className="icon-select2"></i> <span>Pickers</span></a>
                                            <ul>
                                        ...
                                        <li>
                                            <a href="#"><i className="icon-insert-template"></i> <span>Form layouts</span></a>
                                            <ul>
                                        ...
                                        {/* <!-- Appearance --> */}
                                        <li className="navigation-header"><span>Appearance</span> <i className="icon-menu" title="Appearance"></i></li>
                                        <li>
                                            <a href="#"><i className="icon-grid"></i> <span>Components</span></a>
                                            <ul>
                                        ...
                                        <li>
                                            <a href="#"><i className="icon-puzzle2"></i> <span>Content appearance</span></a>
                                            <ul>
                                        ...
                                        <li>
                                            <a href="#"><i className="icon-gift"></i> <span>Extra components</span></a>
                                            <ul>
                                        ...
                                        <li>
                                            <a href="#"><i className="icon-spinner2 spinner"></i> <span>Animations</span></a>
                                            <ul>
                                        ...
                                        <li>
                                            <a href="#"><i className="icon-thumbs-up2"></i> <span>Icons</span></a>
                                            <ul>
                                        ...
                                        {/* <!-- Layout --> */}
                                        <li className="navigation-header"><span>Layout</span> <i className="icon-menu" title="Layout options"></i></li>
                                        <li>
                                            <a href="#"><i className="icon-indent-decrease2"></i> <span>Sidebars</span></a>
                                            <ul>
                                        ...
                                        <li>
                                            <a href="#"><i className="icon-sort"></i> <span>Vertical navigation</span></a>
                                            <ul>
                                        ...
                                        <li>
                                            <a href="#"><i className="icon-transmission"></i> <span>Horizontal navigation</span></a>
                                            <ul>
                                        ...
                                        <li>
                                            <a href="#"><i className="icon-menu3"></i> <span>Navbars</span></a>
                                            <ul>
                                        ...
                                        <li>
                                            <a href="#"><i className="icon-tree5"></i> <span>Menu levels</span></a>
                                            <ul>
                                                <li><a href="#"><i className="icon-IE"></i> Second level</a></li>
                                                <li>
                                                    <a href="#"><i className="icon-firefox"></i> Second level with child</a>
                                                    <ul>
                                                        <li><a href="#"><i className="icon-android"></i> Third level</a></li>
                                                        <li>
                                                            <a href="#"><i className="icon-apple2"></i> Third level with child</a>
                                                            <ul>
                                        ...
                                        <li>
                                            <a href="#"><i className="icon-puzzle4"></i> <span>Extensions</span></a>
                                            <ul>
                                        ...
                                        <li>
                                            <a href="#"><i className="icon-popout"></i> <span>JQuery UI</span></a>
                                            <ul>
                                        ...
                                        <li>
                                            <a href="#"><i className="icon-upload"></i> <span>File uploaders</span></a>
                                            <ul>
                                        ...
                                        <li>
                                            <a href="#"><i className="icon-calendar3"></i> <span>Event calendars</span></a>
                                            <ul>
                                        ...
                                        <li>
                                            <a href="#"><i className="icon-sphere"></i> <span>Internationalization</span></a>
                                            <ul>
                                        ...
                                        {/* <!-- Tables --> */}
                                        <li className="navigation-header"><span>Tables</span> <i className="icon-menu" title="Tables"></i></li>
                                        <li>
                                            <a href="#"><i className="icon-table2"></i> <span>Basic tables</span></a>
                                            <ul>
                                        ...
                                        <li>
                                            <a href="#"><i className="icon-grid7"></i> <span>Data tables</span></a>
                                            <ul>
                                        ...
                                        <li>
                                            <a href="#"><i className="icon-alignment-unalign"></i> <span>Data tables extensions</span></a>
                                            <ul>
                                        ...
                                        <li>
                                            <a href="#"><i className="icon-file-spreadsheet"></i> <span>Handsontable</span></a>
                                            <ul>
                                        ...
                                        <li>
                                            <a href="#"><i className="icon-versions"></i> <span>Responsive options</span></a>
                                            <ul>
                                        ...
                                        {/* <!-- Page kits --> */}
                                        <li className="navigation-header"><span>Page kits</span> <i className="icon-menu" title="Page kits"></i></li>
                                        <li>
                                            <a href="#"><i className="icon-task"></i> <span>Task manager</span></a>
                                            <ul>
                                        ...
                                        <li>
                                            <a href="#"><i className="icon-cash3"></i> <span>Invoicing</span></a>
                                            <ul>
                                        ...
                                        <li>
                                            <a href="#"><i className="icon-people"></i> <span>User pages</span></a>
                                            <ul>
                                        ...
                                        <li>
                                            <a href="#"><i className="icon-user-plus"></i> <span>Login &amp; registration</span></a>
                                            <ul>
                                        ...
                                        <li>
                                            <a href="#"><i className="icon-magazine"></i> <span>Timelines</span></a>
                                            <ul>
                                        ...
                                        <li>
                                            <a href="#"><i className="icon-lifebuoy"></i> <span>Support</span></a>
                                            <ul>
                                        ...
                                        <li>
                                            <a href="#"><i className="icon-search4"></i> <span>Search</span></a>
                                            <ul>
                                        ...
                                        <li>
                                            <a href="#"><i className="icon-images2"></i> <span>Gallery</span></a>
                                            <ul>
                                        ...
                                        <li>
                                            <a href="#"><i className="icon-warning"></i> <span>Error pages</span></a>
                                            <ul>
